...
\subsection{Internship documentation}
The rest of the week was spent on writing documentation of all of the tasks I completed during my internship so far and integrate this information into the company Wiki. The main part here was documenting all the steps included in recreating the \ac{DNNDK} design for the Mars ST3 demonstrator board. A picture of the hardware is shown in figure~\ref
\begin{figure}[!htb]
	\centering
